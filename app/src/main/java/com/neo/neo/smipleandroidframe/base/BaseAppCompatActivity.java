            ...
            switch (v.getId()) {
                case R.id.bt_start_use:
                    if (checkPhoneNumber(2)) {
                        ...
                        basePresenter.login(BaseAppCompatActivity.this, BaseAppCompatActivity.this, etloadPhonenumber.getText().toString().trim(), etLoadCode.getText().toString().trim());
                    }
                    break;
                ...
                case R.id.tv_load_getcode:
                    if (checkPhoneNumber(1)) {
                        time = 120;
                        showProgressBar(true);
                        basePresenter.sendCode(BaseAppCompatActivity.this, BaseAppCompatActivity.this, etloadPhonenumber.getText().toString().trim());
                    }
                    break;
